...
function Franchies() {
  ...
  return (
    ...
    {/* <section className="bg-dark d-md-block d-none">
  <video
    playsInline
    loop
    alt="All the devices"
  ...
  >
    <source src="https://firstfiddle-cp.s3.ap-south-1.amazonaws.com/frntvideo/start.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
  <div className="py-1 text-center">
    <button
      className="btn4 fs-6 text-white franchise-button franchise_signup_btn"
      style={{ height: "54px", background: "rgb(191, 75, 38)" }}
    >
      Franchise sign up
    </button>
  </div>
